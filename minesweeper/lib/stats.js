...
const KEY = 'minesweeper.stats.v1';
...
/**
 * Record a win. Returns { stats, isBest } so the view can celebrate a new
 * personal best. `seconds` is the elapsed play time.
 */
export function recordWin(levelKey, seconds) {
  const stats = load();
